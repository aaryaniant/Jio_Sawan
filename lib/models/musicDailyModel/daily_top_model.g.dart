...
part of 'daily_top_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

DailyTopModel _$DailyTopModelFromJson(Map<String, dynamic> json) =>
    DailyTopModel(
...
Map<String, dynamic> _$DailyTopModelToJson(DailyTopModel instance) =>
    <String, dynamic>{
      'id': instance.id,
