...
class SongInfo extends StatefulWidget {
  final Datum songInfo;
  SongInfo({Key? key, required this.songInfo}) : super(key: key);
...
class _SongInfoState extends State<SongInfo> {
  ...
  void initState() {
    ...
    store.dispatch(action.fetchSongId(context, widget.songInfo.id));
  }
        ...
        child: Column(
          ...
          children: [
            Text(
              ...
              store.state.songInfoModel!.songName
                  .toString()
                  .split("(")
                  .toList()
                  .first,
